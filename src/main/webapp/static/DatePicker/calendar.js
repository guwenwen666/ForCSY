...
My97DP.prototype = {
    ...
    _f: function (p, c, r, e) {
        ...
        for (var i = 0; i < r; i++) {
            ...
            for (var j = 0, b=true; j < c && b; j++) {
            	if((p=="m" || p=="s") && eval(e)>=60){
                    $dt[p] = 59;
                    b=false;
            	}else{
                    $dt[p] = eval(e);
    ...
    _fy: function (_) {
        ...
        $.a('>¡û</td><td align=center class=\'menu\' onmouseover="this.className=\'menuOn\'" onmouseout="this.className=\'menu\'" onmousedown="hide($d.yD);$d.yI.blur();">¡Á</td><td align=right ');
    ...
    _fm: function () {
        this._fHMS('m', 3, 'i * 30 + j * 5')
    },
    _fs: function () {
        this._fHMS('s', 2, 'i * 60 + j * 10')
    },
    _fillQS: function (A) {
        this.initQS();
        var _ = $d.qsDivSel,
        ...
        if (!A) $.a('<div style="float:right;cursor:pointer" onclick="hideSel();hide($d.qsDivSel);">¡Á</div>');
        $.a('</td></tr>');
