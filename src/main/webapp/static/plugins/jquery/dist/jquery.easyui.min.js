...
tip.css({left:pos.left,top:pos.top+10,zIndex:(opts.zIndex!=undefined?opts.zIndex:($.fn.window?$.fn.window.defaults.zIndex++:""))});
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"This field is required.",invalidMessage:null,tipPosition:"top",deltaX:0,novalidate:false,events:{focus:_477,blur:_47b,mouseenter:_47f,mouseleave:_482,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
col.cellClass=_602.cellClassPrefix+"-"+col.field.replace(/[\.|\s]/g,"-").replace(/./g,function($1){return $1.charCodeAt(0).toString(16);});
...
//去掉header的over效果 modify by zhaochunyang@2016-08-29
...
//奇偶行背景色 add by zhaochunyang@2016-08-29
var rowCustomStyle = "";
if(i%2==0){	
	rowCustomStyle = "znjt-data-table-odd-tr";
}
else{
	rowCustomStyle = "znjt-data-table-even-tr";
}
var cls="class=\"datagrid-row "+(_784%2&&opts.striped?"datagrid-row-alt ":" ")+_789+" " + rowCustomStyle +"\"";
...
var width = $(this).panel('panel').outerWidth(true);   
var height = $(this).panel('panel').outerHeight(true);   
